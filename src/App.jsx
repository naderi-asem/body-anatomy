...
function App() {
  ...
  const bodyParts = {
    backParts: [
      { id: 1, name: "backMainHead", src: "./src/assets/manBack/backMAinHead.png", partClass: "col-start-2 row-start-2 left-[33px]" },
      { id: 2, name: "backRightHead", src: "./src/assets/manBack/backRightHead.png", partClass: "row-start-2 col-start-2 left-[87px] top-[22px]" },
      { id: 3, name: "backLeftHead", src: "./src/assets/manBack/backLeftHead.png", partClass: "row-start-2 col-start-2 left-[31px] top-[22px]" },
      { id: 4, name: "backNeck", src: "./src/assets/manBack/backNeck.png", partClass: "row-start-3 col-start-2 left-[33px] -top-[22px]" },
      { id: 5, name: "menBack", src: "./src/assets/manBack/menBack.png", partClass: "row-start-3 col-start-2 left-[11px] top-[18px]" },
      { id: 6, name: "menWaist", src: "./src/assets/manBack/menWaist.png", partClass: "row-start-4 col-start-2 left-[20px] top-[60px]" },
      { id: 7, name: "backRightArm", src: "./src/assets/manBack/backRightArm.png", partClass: "row-start-3 col-start-3 -left-[9px] top-[30px]" },
      { id: 8, name: "backLeftArm", src: "./src/assets/manBack/backLeftArm.png", partClass: "row-start-3 col-start-2 top-[29px] -left-[26px]" },
      { id: 9, name: "rightElbow", src: "./src/assets/manBack/rightElbow.png", partClass: "row-start-4 col-start-3 top-[25px] left-[9px]" },
      { id: 10, name: "leftElbow", src: "./src/assets/manBack/leftElbow.png", partClass: "row-start-4 col-start-2 -left-[33px] top-[20px]" },
      { id: 11, name: "backRightForeArm", src: "./src/assets/manBack/backRightForeArm.png", partClass: "row-start-4 col-start-3 left-[10px] top-[49px]" },
      { id: 12, name: "backLeftForeArm", src: "./src/assets/manBack/backLeftForeArm.png", partClass: "row-start-4 col-start-2 -left-[35px] top-[45px]" },
      { id: 13, name: "rightHand", src: "./src/assets/manBack/rightHand.png", partClass: "row-start-5 col-start-3 top-[29px] left-[19px]" },
      { id: 14, name: "leftHand", src: "./src/assets/manBack/leftHand.png", partClass: "row-start-5 col-start-2 top-[27px] -left-[36px]" },
      { id: 15, name: "menLowerBody", src: "./src/assets/manBack/menLowerBody.png", partClass: "row-start-5 col-start-2 left-[12px] -top-[3px]" },
      { id: 16, name: "Circle", src: "./src/assets/manBack/circle.png", partClass: "row-start-5 col-start-2 left-[56px] top-[21px]" },
      { id: 17, name: "backRightThigh", src: "./src/assets/manBack/backRightThigh.png", partClass: "row-start-5 col-start-3 -left-[67px] top-[37px]" },
      { id: 18, name: "backLeftThigh", src: "./src/assets/manBack/backLeftThigh.png", partClass: "row-start-5 col-start-2 left-[11px] top-[40px]" },
      { id: 19, name: "backRightLeg", src: "./src/assets/manBack/backRightLeg.png", partClass: "row-start-6 col-start-3 -left-[45px] top-[62px]" },
      { id: 20, name: "backLeftLeg", src: "./src/assets/manBack/backLeftLeg.png", partClass: "row-start-6 col-start-2 left-[10px] top-[62px]" },
      { id: 21, name: "backRightFoot", src: "./src/assets/manBack/backRightFoot.png", partClass: "row-start-8 col-start-3 -left-[37px] top-[1px]" },
      { id: 22, name: "backLeftFoot", src: "./src/assets/manBack/backLeftFoot.png", partClass: "row-start-8 col-start-2 -left-[5px] top-[1px]" },
    ],
    frontParts: [
